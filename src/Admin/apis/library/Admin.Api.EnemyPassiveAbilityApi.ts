...
export class AdminEnemyPassiveAbilityApi extends LibraryApi<typeof LibraryApiServerConfig.EnemyPassiveAbilityApiConfig> {
    ...
    public async create(ability: EnemyPassiveAbility): Promise<ApiResponse<EnemyPassiveAbility>> {
        try {
    ...
    public async update(ability: EnemyPassiveAbility): Promise<ApiResponse<EnemyPassiveAbility>> {
        try {
